...
@section('containter')
    ...
    @if (session()->has('success-edit'))
        <div class="notification">
            ...
            <div class="alert alert-warning" role="alert">
                <strong class="strong-edit">New User has been updated!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
    ...
    <div class="add-user">
        ...
        <img class="bg-pict-user" src="IMG/bg-pict-user.png" alt="bg-pict-user">
        <img class="pict-user" src="IMG/pict-user.png" alt="pict-user">
                ...
                <tbody>
                    ...
                    <tr class="tr-list">
                            ...
                            <td class="td-action" align="center">
                                <button class="edit-button" data-bs-toggle="modal" data-bs-target="#editUser{{ $user->user_id }}">
    ...
    @foreach ( $users as $user )
        ...
        {{-- MODAL EDIT USER --}}
        <div class="modal fade" id="editUser{{ $user->user_id }}" tabindex="-1" aria-labelledby="editUserLabel" aria-hidden="true">
                            ...
                            <tr>
                                <td>
                                    <div class="edit-user-id">
                                        <label for="user_id" class="form-label">ID</label>
                                        <input type="text" value="{{ $user->user_id }}" name="user_id" id="user_id" placeholder="Enter id" required value="{{ old("user_id") }}" readonly>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="edit-user-name">
                                        <label for="name" class="form-label">Name</label>
                                        <input type="text" value="{{ $user->name }}" name="name" id="name"  placeholder="Enter name" required value="{{ old("name") }}">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="edit-user-email">
                                        ...
                                        <input type="email" value="{{ $user->email }}" name="email" id="email" placeholder="Enter email" required value="{{ old("email") }}" autofocus>
                                    </div>
                                </td>
                            </tr>
                            {{-- <tr>
