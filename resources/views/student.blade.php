...
@section('containter')
    ...
    <div class="add-student">
        ...
        <img class="bg-pict-student" src="IMG/bg-pict-student.png" alt="bg-pict-student">
        <img class="pict-student" src="IMG/pict-student.png" alt="pict-student">
                ...
                <tbody>
                    ...
                    <tr class="tr-list">
                        ...
                        <td class="td-action" align="center">
                            <button class="edit-button" data-bs-toggle="modal" data-bs-target="#editStudents{{ $student->student_id }}">
                            ...
                            <td class="td-list" align="center">
                                <button class="delete-button" data-bs-toggle="modal" data-bs-target="#deleteStudents{{ $student->student_id }}">
    ...
    @foreach ( $students as $student )
        ...
        <div class="modal fade" id="editStudents{{ $student->student_id }}" tabindex="-1" aria-labelledby="editStudentLabel" aria-hidden="true">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <div class="edit-id">
                                        <label for="student_id" class="form-label">ID</label>
                                        <input type="text" value="{{ $student->student_id }}" name="student_id" id="student_id" placeholder="Enter id" required readonly>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="edit-name">
                                        <label for="student_name" class="form-label">Name</label>
                                        <input type="text" value="{{ $student->student_name }}" name="student_name" id="student_name" @error("student_name") is-invalid @enderror" placeholder="Enter name" required autofocus>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="edit-birth">
                                        <label for="date_of_birth" class="form-label">Birth Date</label>
                                        <input type="date" value="{{ $student->date_of_birth }}" name="date_of_birth" id="date_of_birth" placeholder="Enter birth date" required>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="edit-entrance">
                                        <label for="year_entrance" class="form-label">Entrance</label>
                                        <input type="number" value="{{ $student->year_entrance }}" name="year_entrance" id="year_entrance" placeholder="Enter entrance" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    @foreach ( $students as $student )
        ...
        {{-- DIV MODAL TARGETING FROM BUTTON --}}
        <div class="modal fade" id="deleteStudents{{ $student->student_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form action="/student/delete" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" value="{{ $student->student_id }}" name="student_id" id="student_id" placeholder="Enter id" hidden readonly>
                        </div>
                        <div class="modal-footer">
